...
@section('content')
    ...
    <form id="crud_form" class="ajax-form" action="{{ route('dashboard.customers_rates.store') }}" method="post"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="fv-row flex-row-fluid">
                            ...
                            <!--end::Select2-->
                            <div class="fv-plugins-message-container invalid-feedback" id="rate">
                            </div>
                        </div>
                        ...
                        <div class="fv-row mb-0 fv-plugins-icon-container">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">{{ __('Comment') }}</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-12 fv-row">
                                <textarea class="form-control form-control-lg form-control-solid" name="comment" id="comment_inp"
                                    placeholder="{{ __('Comment') }}" data-kt-autosize="true"></textarea>
    ...
    <script>
        $(document).ready(function() {
            $("#add_btn").click(function(e) {
                ...
                $("#crud_form").attr('action', `/dashboard/customers_rates`);
