...
@section('content')
    ...
    <div class="card mb-5 mb-x-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{ __('Children list') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <input type="text" data-kt-docs-table-filter="search"
                        class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search for Children') }}">
                </div>
                <!--end::Search-->
                <!--begin::Toolbar-->
    ...
    <form id="crud_form" class="ajax-form" action="{{ route('dashboard.children.store') }}" method="post"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="fv-row mb-0 fv-plugins-icon-container">
                            ...
                            <input type="text" name="name" class="form-control form-control-lg form-control-solid"
                                id="name_inp" placeholder="{{ __('children name') }}">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/dashboard/js/datatables/children.js') }}"></script>
