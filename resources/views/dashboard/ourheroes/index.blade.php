    ...
    <div class="card mb-5 mb-x-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{ __('our heroes list') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <input type="text" data-kt-docs-table-filter="search"
                        ...
                        placeholder="{{ __('Search for Our heroes') }}">
                </div>
                <!--end::Search-->
                <!--begin::Toolbar-->
                <div class="d-flex justify-content-end" id="add_btn" data-bs-toggle="modal" data-bs-target="#crud_modal"
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="tooltip"
                        ...
                        <!--end::Svg Icon-->{{ __('Add hero') }}</button>
                    <!--end::Add customer-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex flex-row justify-content-center  align-items-center px-10">
                            <!-- Image Upload Field -->
                        ...
                        <div class="fv-row mb-0 fv-plugins-icon-container">
                            <!--end::Label-->
                            <label class="required fs-5 fw-semibold mb-2">{{ __('City') }}</label>
                            <!--end::Label-->
...
@push('scripts')
    ...
    <script src="{{ asset('assets/dashboard/js/datatables/ourhero.js') }}"></script>
