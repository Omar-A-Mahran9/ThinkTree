...
@section('content')
            ...
            <div class="card border-hover-primary h-100">
                ...
                <div class="card-header border-0 pt-9">
                    ...
                    <div class="card-title m-0">
                        ...
                        <h4 class="fw-bold me-auto px-4 py-3">{{ __('Addons') }}</h4>
                ...
                <div class="card-body p-9">
                    ...
                    <div class="d-flex  justify-content-between flex-wrap ">
                        ...
                        <div class=" rounded min-w-125px py-1 px-4 me-7">
                            <div class="fs-2 fw-bold">{{ __('addon count') }}</div>
                            <div class="fs-4  ">{{ $count_addon }}</div>
                        </div>
                        <!--end::Due-->
    ...
    <div class="card mb-5 mb-x-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <!--begin::Card title-->
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{ __('Addons list') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <input type="text" data-kt-docs-table-filter="search"
                        ...
                        placeholder="{{ __('Search for Addons') }}">
                </div>
                <!--end::Search-->
            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="form_title">{{ __('Add new Addon') }}</h5>
                        <!--begin::Close-->
                    ...
                    <div class="modal-body">
                        ...
                        <div class="fv-row mb-0 fv-plugins-icon-container">
                            ...
                            <input type="text" name="price" class="form-control form-control-lg form-control-solid"
                                id="price_inp" placeholder="{{ __('price') }}">
